...
function ServerIcon({ color, letter }: { color: string; letter: string }) {
	return (
		<div
	...
	return (
		<div className="flex flex-col">
			<div className="mb-8 flex items-center gap-5">
				<UserCircleIcon />
				<h1 className="text-3xl font-bold text-white">Discord Username</h1>
			</div>
			...
			<div>
				...
				<button
					type="button"
					className="mt-5 rounded-full bg-[#1752f0] px-5 py-2 text-sm font-semibold text-white transition-colors duration-150 hover:bg-[#368bfe]"
				>
					Add Server
				</button>
			</div>

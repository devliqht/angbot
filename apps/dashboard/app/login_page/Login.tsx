    ...
    <div className="flex h-screen items-center justify-center bg-[#1E1E1E]">
      ...
      >
        ...
        <p className="mb-10 text-center text-sm text-[#7c7c7c]">
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg bg-[#1752f0] py-4 text-base font-semibold text-white transition-colors duration-150 hover:bg-[#368bfe] active:scale-95"
        ><Image
            src={discordLogo}
            width={30}
            height={30}

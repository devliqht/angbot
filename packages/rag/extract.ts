...
const TEXT_CODE_EXTENSIONS = new Set([
	"txt", "md", "rmd", "markdown", "csv", "tsv", "json", "yaml", "yml", "xml", "html", "css",
	"c", "cpp", "h", "hpp", "cs", "java", "py", "js", "jsx", "ts", "tsx", "sql", "sh", "bat",
	"ps1", "r", "kt", "kts", "swift", "go", "rs", "php", "rb", "m", "tex", "log", "ini", "env"
]);
